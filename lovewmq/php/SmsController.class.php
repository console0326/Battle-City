...
class SmsController
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIksIyiMFpz3rD"; // AccessKeyId

        $accessKeySecret = "gHHoen2y64ipq0QvBiWR1e4S5T0lYu"; // AccessKeySecret
    ...
    public static function sendSms() {
        ...
        $request->setSignName("旗哥1");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_126460395");
...
//$response = SmsController.class::sendBatchSms();
//echo "批量发送短信(sendBatchSms)接口返回的结果:\n";
//print_r($response);
//
//sleep(2);
//
//$response = SmsController.class::querySendDetails();
